// Melo/Audio/Monitors/AudioDeviceMonitor.swift
import AppKit
import AudioToolbox
import os
...
final class AudioDeviceMonitor: AudioDeviceProviding {
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "Melo", category: "AudioDeviceMonitor")
    ...
    private func refresh() {
        ...
        do {
            ...
            for deviceID in deviceIDs {
                ...
                // Melo's own internal aggregates (used for process taps) are
                ...
                // etc.) pass through.
                if deviceID.isAggregateDevice() && name.hasPrefix("Melo-") { continue }

// Melo/Views/Components/AutoEQSearchPanel.swift
import SwiftUI
...
struct AutoEQSearchPanel: View {
    ...
    var body: some View {
        ...
        .animation(DesignTokens.Animation.rowChange, value: fetchError)
        .animation(DesignTokens.Animation.rowChange, value: importErrorMessage)
        .background {
    ...
    private func statusCard(id: String, name: String, source: String?) -> some View {
        ...
        .animation(DesignTokens.Animation.toggle, value: isCorrectionEnabled)

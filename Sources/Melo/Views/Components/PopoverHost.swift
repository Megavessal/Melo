// Melo/Views/Components/PopoverHost.swift
import SwiftUI
import AppKit
...
struct PopoverHost<Content: View>: NSViewRepresentable {
    ...
    class Coordinator: NSObject {
        ...
        // Swift 6.3.3's EarlyPerfInliner crashes while optimizing this generic
        // coordinator's destructor. Keep the tiny safety-net cleanup unoptimized.
        @_optimize(none)
        isolated deinit {
            if let monitor = localEventMonitor {
                NSEvent.removeMonitor(monitor)

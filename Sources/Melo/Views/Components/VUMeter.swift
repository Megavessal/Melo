// Melo/Views/Components/VUMeter.swift
import SwiftUI
...
struct VUMeter: View {
    ...
    var body: some View {
        ...
        .frame(width: DesignTokens.Spacing.sm2, height: DesignTokens.Dimensions.rowContentHeight - 4)
        // Purely decorative: it duplicates level information VoiceOver already
        // gets from the slider's value, and eight bars announced one at a time
        // is noise between the mute button and the volume control.
...
private struct VUMeterBar: View {
    ...
    var body: some View {
        DesignTokens.Dimensions.Shape.custom(0.5)

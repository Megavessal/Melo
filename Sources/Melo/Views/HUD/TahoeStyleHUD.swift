// Melo/Views/HUD/TahoeStyleHUD.swift
import SwiftUI
...
struct TahoeStyleHUD: View {
    ...
    /// Continuous curvature, not circular. This panel is shown inches from
    /// the system volume HUD, which is a squircle; a circular 22pt corner
    /// beside it reads as a third-party imitation.
    ...
    private var sliderAccessibilityTitle: String {
        let device = deviceName.isEmpty ? "Output" : deviceName
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: DesignTokens.Spacing.sm) {
            ...
            HStack(spacing: DesignTokens.Spacing.sm) {
                ...
                LiquidGlassSlider(
                    ...
                    accessibilityTitle: sliderAccessibilityTitle
                )
        ...
        // `.contain`, not `.ignore`: this HUD holds a live slider, and
        // flattening the panel into one static label deleted the only way a
        // VoiceOver user could change volume from it.

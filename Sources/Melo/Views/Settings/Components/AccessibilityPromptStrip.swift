// Melo/Views/Settings/Components/AccessibilityPromptStrip.swift
import SwiftUI
...
struct AccessibilityPromptStrip: View {
    ...
    var body: some View {
        HStack(spacing: DesignTokens.Spacing.sm) {
            ...
            if showingGrantedFlourish {
                ...
                .accessibilityHint("Registers Melo in the Accessibility list and opens System Settings.")
            }
        }
    ...
    private var message: String {
        showingGrantedFlourish
            ? "Access granted — volume keys now control Melo."
            : "Let your Mac’s volume keys control Melo."
    }

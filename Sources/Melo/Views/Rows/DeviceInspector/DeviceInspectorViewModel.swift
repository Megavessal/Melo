// Melo/Views/Rows/DeviceInspector/DeviceInspectorViewModel.swift
import AudioToolbox
import CoreAudio
import Foundation
import os
...
final class DeviceInspectorViewModel {
    ...
    private static func snapshot(
        ...
        return DeviceInspectorInfo(
            ...
            estimatedLatencyMilliseconds: deviceID.readEstimatedOutputLatencyMilliseconds(sampleRate: sampleRate),
            clockSourceName: deviceID.readClockSourceName(),

// Melo/Shortcuts/TargetAppResolver.swift
import AppKit
import Foundation
...
final class TargetAppResolver: TargetAppResolving {
    ...
    private var lastNonMeloFrontmostBundleID: String?
    ...
    func handleActivation(bundleID: String?) {
        ...
        lastNonMeloFrontmostBundleID = bundleID
    }
    ...
    func resolveTargetBundleID(audibleCandidates: [String]) -> String? {
        ...
        guard !filtered.isEmpty else {
            return resolveFrontmostNonMelo()
        }
    ...
    private func resolveFrontmostNonMelo() -> String? {
        let frontmost = frontmostBundleIDProvider()
        if let frontmost, frontmost != ownBundleID {
            return frontmost
        }
        return lastNonMeloFrontmostBundleID
    }
}

// Melo/Utilities/URLHandler.swift
import Foundation
import os
...
/// Handles URL scheme actions for Melo (melo://...)
@MainActor
final class URLHandler {
    private let audioEngine: any URLHandlerEngine
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "Melo", category: "URLHandler")
    ...
    /// URL format: melo://set-volumes?app=com.a&volume=100&app=com.b&volume=50
    ...
    /// URL format: melo://step-volume?app=com.a&direction=up (or down)
    ...
    /// URL format: melo://set-mute?app=com.a&muted=true&app=com.b&muted=false
    ...
    /// URL format: melo://toggle-mute?app=com.a&app=com.b
    ...
    /// URL format: melo://set-device?app=com.a&device=<deviceUID>
